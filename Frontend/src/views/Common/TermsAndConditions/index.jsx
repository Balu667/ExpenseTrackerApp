				...
				<div className="container" style={{ paddingTop: "60px" }}>
					<div className="row">
						<div className="col-md-12">
							...
							<p>Welcome to AllMasters!</p>
							<p>
								These terms and conditions outline the rules and
								regulations for the use of samples Website,
								located at AllMasters.ai
							</p>
							<p>
								By accessing this website we assume you accept
								these terms and conditions. Do not continue to
								use localhost if you do not agree to take all of
							...
							<p>
								...
								refers to you, the person log on this website
								and compliant to the Company terms and
								...
								purpose of meeting the Clients needs in respect
								of provision of the Company stated services, in
								accordance with and subject to, prevailing law
								of in. Any use of the above terminology or other
								words in the singular, plural, capitalization
								and/or he/she or they, are taken as
							...
							<p>
								...
								localhost, you agreed to use cookies in
								agreement with the samples Privacy Policy.{" "}
							</p>
							<p>
								Most interactive websites use cookies to let us
								retrieve the users details for each visit.
							...
							<p>
								Unless otherwise stated, sample and/or its
								licensors own the intellectual property rights
								for all material on localhost. All intellectual
								property rights are reserved. You may access
								this from localhost for your own personal use
								subjected to restrictions set in these terms and
								conditions.
							</p>
							<p>You must not:</p>
							<ul>
								<li>Republish material from localhost</li>
								<li>
								...
								<li>Redistribute content from localhost</li>
							</ul>
							<p>
							...
							<p>
								You hereby grant sample a non-exclusive license
								to use, reproduce, edit and authorize others to
							...
							<p>
								...
								absence of sample; and (d) the link is in the
							...
							<p>
								...
								e-mail to sample. Please include your name, your
							...
							<p>
								No use of sample logo or other artwork will be
							...
							<p>
								...
								right to amen these terms and conditions and its
